			...
			foreach ( $errors as $error ) {
				switch ( $error ) {
					case 'empty_student_id':
						echo '<li>' . __( 'Please select a student', 'edr' ) . '</li>';
						break;
					case 'empty_object_id':
						if ( 'course' == $payment->payment_type ) {
							echo '<li>' . __( 'Please select a course', 'edr' ) . '</li>';
						} else {
							echo '<li>' . __( 'Please select a membership', 'edr' ) . '</li>';
						}
						break;
				}
			}
				...
				<div id="postbox-container-1" class="postbox-container">
					<div id="side-sortables" class="meta-box-sortables">
						<div id="payment-settings" class="postbox">
							...
							<h3 class="hndle"><span><?php _e( 'Payment', 'edr' ); ?></span></h3>
							<div class="inside">
								<!-- Payment Type -->
								<div class="edr-field edr-field_block">
									<div class="edr-field__label">
										<label for="payment-type"><?php _e( 'Payment Type', 'edr' ); ?></label>
									</div>
								...
								<!-- Status -->
								<div class="edr-field edr-field_block">
									<div class="edr-field__label"><label for="payment-status"><?php _e( 'Status', 'edr' ); ?></label></div>
									<div class="edr-field__control">
								...
								<!-- Entry ID -->
								<div class="edr-field edr-field_block" data-type="course"<?php if ( 'course' != $payment->payment_type ) echo ' style="display:none;"'; ?>>
									<div class="edr-field__label">
										<label for="entry-id"><?php _e( 'Entry ID', 'edr' ); ?></label>
									</div>
									<div class="edr-field__control">
										<?php
											if ( $payment->ID ) {
											...
											$entry_value = $entry ? intval( $entry->ID ) : __( 'This payment is not connected to any entry.', 'edr' );
										?>
										<input type="text" id="entry-id" value="<?php echo $entry_value; ?>" disabled="disabled">
										<?php if ( ! $entry ) : ?>
											<p id="edr-create-entry-checkbox">
												<label><input type="checkbox" name="create_entry" value="1"> <?php _e( 'Create an entry for this student', 'edr' ); ?></label>
											</p>
										<?php endif; ?>
									</div>
								</div>
								...
								<div class="edr-field edr-field_block">
									<div class="edr-field__label">
										<label><?php _e( 'Student', 'edr' ); ?><span class="required">*</span></label>
									</div>
									<div class="edr-field__control">
								...
								<div class="edr-field edr-field_block">
									<div class="edr-field__label">
										<label for="payment-gateway"><?php _e( 'Payment Method', 'edr' ); ?></label>
									</div>
									<div class="edr-field__control">
										<select name="payment_gateway" id="payment-gateway">
											<option value="">&mdash; <?php _e( 'Select', 'edr' ); ?> &mdash;</option>
											<?php
								...
								<div class="edr-field edr-field_block">
									<div class="edr-field__label">
										<label for="payment-txn-id"><?php _e( 'Transaction ID', 'edr' ); ?></label>
									</div>
									<div class="edr-field__control">
								...
								<?php if ( $payment->ip ) : ?>
									<div class="edr-field edr-field_block">
										<div class="edr-field__label"><label><?php _e( 'IP', 'edr' ); ?></label></div>
				...
				<div id="postbox-container-2" class="postbox-container">
					<div id="normal-sortables" class="meta-box-sortables">
						<div id="payment-items" class="postbox">
							<div class="handlediv"><br></div>
							<h3 class="hndle"><span><?php _e( 'Items', 'edr' ); ?></span></h3>
							<div class="inside">
								<!-- Course -->
								<div class="edr-field" data-type="course"<?php if ( 'course' != $payment->payment_type ) echo ' style="display:none;"'; ?>>
									<div class="edr-field__label"><label><?php _e( 'Course', 'edr' ); ?><span class="required">*</span></label></div>
									<div class="edr-field__control">
										<?php
								...
								<div class="edr-field" data-type="membership"<?php if ( 'membership' != $payment->payment_type ) echo ' style="display:none;"'; ?>>
									<div class="edr-field__label"><label for="payment-membership-id"><?php _e( 'Membership', 'edr' ); ?></label></div>
									<div class="edr-field__control">
										<div>
											...
											<p>
												<label><input type="checkbox" name="setup_membership" value="1"> <?php
													if ( $user_membership ) {
														_e( 'Update membership for this student', 'edr' );
													} else {
														_e( 'Setup membership for this student', 'edr' );
													}
												?></label>
											</p>
										</div>
								...
								<!-- Tax -->
								<div class="edr-field">
									<div class="edr-field__label"><label for="payment-tax"><?php _e( 'Tax', 'edr' ); ?></label></div>
									<div class="edr-field__control">
								...
								<!-- Total Amount -->
								<div class="edr-field">
									<div class="edr-field__label"><label for="payment-amount"><?php _e( 'Total Amount', 'edr' ); ?></label></div>
									<div class="edr-field__control">
										<input type="text" id="payment-amount" class="regular-text" name="amount" value="<?php echo ( $payment->amount ) ? (float) $payment->amount : 0.00; ?>">
										<div class="description"><?php _e( 'A number with a maximum of 2 figures after the decimal point (for example, 9.99).', 'edr' ); ?></div>
									</div>
								</div>

								<!-- Currency -->
								<div class="edr-field">
									<div class="edr-field__label"><label for="payment-currency"><?php _e( 'Currency', 'edr' ); ?></label></div>
									<div class="edr-field__control">
										<select id="payment-currency" name="currency">
											<option value=""><?php _e( 'Select Currency', 'edr' ); ?></option>
											<?php
						...
						<div id="payment-billing" class="postbox">
							<div class="handlediv"><br></div>
							<h3 class="hndle"><span><?php _e( 'Billing', 'edr' ); ?></span></h3>
							<div class="inside">
								<!-- First Name -->
								<div class="edr-field">
									<div class="edr-field__label"><label for="payment-first-name"><?php _e( 'First Name', 'edr' ); ?></label></div>
									<div class="edr-field__control">
								...
								<!-- Last Name -->
								<div class="edr-field">
									<div class="edr-field__label"><label for="payment-last-name"><?php _e( 'Last Name', 'edr' ); ?></label></div>
									<div class="edr-field__control">
								...
								<!-- Address -->
								<div class="edr-field">
									<div class="edr-field__label"><label for="payment-address"><?php _e( 'Address', 'edr' ); ?></label></div>
									<div class="edr-field__control">
								...
								<!-- Address Line 2 -->
								<div class="edr-field">
									<div class="edr-field__label"><label for="payment-address-2"><?php _e( 'Address Line 2', 'edr' ); ?></label></div>
									<div class="edr-field__control">
								...
								<!-- City -->
								<div class="edr-field">
									<div class="edr-field__label"><label for="payment-city"><?php _e( 'City', 'edr' ); ?></label></div>
									<div class="edr-field__control">
								...
								<!-- Postcode / Zip -->
								<div class="edr-field">
									<div class="edr-field__label"><label for="payment-postcode"><?php _e( 'Postcode / Zip', 'edr' ); ?></label></div>
									<div class="edr-field__control">
								...
								<!-- State / Province -->
								<div class="edr-field">
									<div class="edr-field__label"><label for="payment-state"><?php _e( 'State / Province', 'edr' ); ?></label></div>
									<div class="edr-field__control">
										<?php
								...
								<!-- Country -->
								<div class="edr-field">
									<div class="edr-field__label"><label for="payment-country"><?php _e( 'Country', 'edr' ); ?></label></div>
									<div class="edr-field__control">
						...
						<?php if ( ! empty( $lines ) ) : ?>
							<div class="postbox">
								<div class="handlediv"><br></div>
								<h3 class="hndle"><?php _e( 'Payment Lines', 'edr' ); ?></h3>
								<div class="inside">
									<table class="edr-payment-lines">
										<thead>
											<tr>
												<th><?php _e( 'Type', 'edr' ); ?></th>
												<th><?php _e( 'Reference ID', 'edr' ); ?></th>
												<th><?php _e( 'Amount', 'edr' ); ?></th>
												<th><?php _e( 'Tax', 'edr' ); ?></th>
