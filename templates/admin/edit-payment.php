				...
				<div id="postbox-container-1" class="postbox-container">
					<div id="side-sortables" class="meta-box-sortables">
						<div id="payment-settings" class="postbox">
							...
							<h3 class="hndle"><span><?php _e( 'Payment', 'educator' ); ?></span></h3>
							<div class="inside">
								<!-- Payment Type -->
				...
				<div id="postbox-container-2" class="postbox-container">
					<div id="normal-sortables" class="meta-box-sortables">
						<div id="payment-items" class="postbox">
							<div class="handlediv"><br></div>
							<h3 class="hndle"><span><?php _e( 'Items', 'educator' ); ?></span></h3>
							<div class="inside">
								<!-- Course -->
								...
								<div class="edr-field" data-type="membership"<?php if ( 'membership' != $payment->payment_type ) echo ' style="display:none;"'; ?>>
									<div class="edr-field__label"><label for="payment-membership-id"><?php _e( 'Membership', 'educator' ); ?></label></div>
									<div class="edr-field__control">
										<div>
								...
								<div class="edr-field">
									...
									<div class="edr-field__control">
										...
										<div class="description"><?php _e( 'A number with a maximum of 2 figures after the decimal point (for example, 9.99).', 'educator' ); ?></div>
									</div>
								</div>
						...
						<div id="payment-billing" class="postbox">
							<div class="handlediv"><br></div>
							<h3 class="hndle"><span><?php _e( 'Billing', 'educator' ); ?></span></h3>
							<div class="inside">
								<!-- First Name -->
								<div class="edr-field">
						...
						<?php if ( ! empty( $lines ) ) : ?>
							<div class="postbox">
								<div class="handlediv"><br></div>
								<h3 class="hndle"><?php _e( 'Payment Lines', 'educator' ); ?></h3>
								<div class="inside">
