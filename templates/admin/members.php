...
<div class="wrap">
	<h2>
		<?php _e( 'Educator Members', 'edr' ); ?>
		<a href="<?php echo esc_url( admin_url( 'admin.php?page=edr_admin_members&edr-action=edit-member' ) ); ?>" class="add-new-h2"><?php _e( 'Add New', 'edr' ); ?></a>
	</h2>
