...
<div class="wrap">
	<h2>
		<?php _e( 'Educator Payments', 'edr' ); ?>
		<a href="<?php echo esc_url( admin_url( 'admin.php?page=edr_admin_payments&edr-action=edit-payment' ) ); ?>" class="add-new-h2"><?php _e( 'Add New', 'edr' ); ?></a>
	</h2>
